...
5. identificar contato e sessão
6. resolver instância Hermes
7. montar contexto
8. chamar Hermes
9. Hermes escolhe função autorizada
10. sistema executa função
11. persistir resultado
12. responder via provider
13. registrar log/auditoria
